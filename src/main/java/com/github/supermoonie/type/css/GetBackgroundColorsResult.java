...
public class GetBackgroundColorsResult {
     ...
     * If no visible text is present, this will be undefined.
     * In the case of a flat background color, this will consist of simply that color.
     * In the case of a gradient, this will consist of each of the color stops.
